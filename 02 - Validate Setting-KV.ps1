...
$Results2 | select ResourceNameResourceGroup,ResourceID,Location,Tags,AllowPublicAccess,ResrictAccess,DisableAccess,WhitelistIP | Export-Csv -Path $path -NoTypeInformation
